...
public class Walker
{
  ...
  {
	  if (stepsCount % 2 == 0)  // if stepsCount is even
	      leftFoot.moveForward(stepLength); //leftFoot moves forward 100 pixels
	    else  
	      rightFoot.moveForward(stepLength); //rightFoot moves forward 100 pixels
  ...
  {
	  leftFoot.draw(g); //draws leftFoot
	  rightFoot.draw(g); //draws rightFoot
  }
}
